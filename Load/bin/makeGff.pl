...
unless($skipExtraAnnotation) {
  my $sql = "select t.so_term_name, s.source_id as sequence_source_id, s.length, t.gene_source_id, t.old_gene_product, t.gene_name, t.source_id as transcript_source_id, t.transcript_product, t.ncbi_tax_id, t.ec_numbers, t.annotated_go_id_function, t.annotated_go_id_component,t.annotated_go_id_process
                   from webready.transcriptattributes t, dots.nasequence s, sres.externaldatabaserelease r, sres.externaldatabase d
