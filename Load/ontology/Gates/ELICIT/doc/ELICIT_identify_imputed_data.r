...
length(d$is_mthr_height_imputed[d$is_mthr_height_imputed=="yes" & !is.na(d$is_mthr_height_imputed)])
...
length(d$is_mthr_weight_imputed[d$is_mthr_weight_imputed=="yes" & !is.na(d$is_mthr_weight_imputed)])
