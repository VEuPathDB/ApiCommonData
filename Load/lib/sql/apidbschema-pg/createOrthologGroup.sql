CREATE TABLE apidb.OrthologGroup (
 ...
 subclass_view                character varying(30) NOT NULL,
 name                         character varying(500),
 description                  character varying(2000),
 NUMERIC_of_members            NUMERIC(12) NOT NULL,
 avg_percent_identity         FLOAT,
 avg_percent_match            FLOAT,
 avg_evalue_mant              FLOAT,
 avg_evalue_exp               NUMERIC,
 avg_connectivity             FLOAT(40),
...
CREATE INDEX og_mem_ix ON apidb.OrthologGroup (NUMERIC_of_members, ortholog_group_id);
...
WHERE lower('OrthologGroup') NOT IN (SELECT lower(name) FROM core.TableInfo
...
SELECT nextval('core.tableinfo_sq'), 'OrthomclTaxon',
       ...
       1,current_timestamp, 1, 1, 1, 1, 1, 1, 1, 1,
       (SELECT MAX(project_id) AS project_id FROM core.ProjectInfo), 0
WHERE lower('OrthomclTaxon') NOT IN (SELECT lower(name) FROM core.TableInfo
        WHERE database_id = (SELECT database_id FROM core.DatabaseInfo WHERE lower(name) = 'apidb'));
...
SELECT nextval('core.tableinfo_sq'), 'GroupTaxonMatrix',
       ...
       1,current_timestamp, 1, 1, 1, 1, 1, 1, 1, 1,
       (SELECT MAX(project_id) AS project_id FROM core.ProjectInfo), 0
WHERE lower('GroupTaxonMatrix') NOT IN (SELECT lower(name) FROM core.TableInfo
        WHERE database_id = (SELECT database_id FROM core.DatabaseInfo WHERE lower(name) = 'apidb'));
...
SELECT nextval('core.tableinfo_sq'), 'OrthologGroupAaSequence',
       ...
       1,current_timestamp, 1, 1, 1, 1, 1, 1, 1, 1,
       (SELECT MAX(project_id) AS project_id FROM core.ProjectInfo), 0
WHERE lower('OrthologGroupAaSequence') NOT IN (SELECT lower(name) FROM core.TableInfo
        WHERE database_id = (SELECT database_id FROM core.DatabaseInfo WHERE lower(name) = 'apidb'));
...
SELECT nextval('core.tableinfo_sq'), 'OrthomclResource',
       ...
       1,current_timestamp, 1, 1, 1, 1, 1, 1, 1, 1,
       (SELECT MAX(project_id) AS project_id FROM core.ProjectInfo), 0
WHERE lower('OrthomclResource') NOT IN (SELECT lower(name) FROM core.TableInfo
        WHERE database_id = (SELECT database_id FROM core.DatabaseInfo WHERE lower(name) = 'apidb'));
...
CREATE INDEX ogk_group_ix ON apidb.OrthomclGroupKeyword(ortholog_group_id);
...
SELECT nextval('core.tableinfo_sq'), 'OrthomclGroupKeyword',
       ...
       1,current_timestamp, 1, 1, 1, 1, 1, 1, 1, 1,
       (SELECT MAX(project_id) AS project_id FROM core.ProjectInfo), 0
WHERE lower('OrthomclGroupKeyword') NOT IN (SELECT lower(name) FROM core.TableInfo
        WHERE database_id = (SELECT database_id FROM core.DatabaseInfo WHERE lower(name) = 'apidb'));
...
CREATE INDEX ogd_group_ix ON apidb.OrthomclGroupDomain(ortholog_group_id);
...
SELECT nextval('core.tableinfo_sq'), 'OrthomclGroupDomain',
       ...
       1,current_timestamp, 1, 1, 1, 1, 1, 1, 1, 1,
       (SELECT MAX(project_id) AS project_id FROM core.ProjectInfo), 0
WHERE lower('OrthomclGroupDomain') NOT IN (SELECT lower(name) FROM core.TableInfo
        WHERE database_id = (SELECT database_id FROM core.DatabaseInfo WHERE lower(name) = 'apidb'));
