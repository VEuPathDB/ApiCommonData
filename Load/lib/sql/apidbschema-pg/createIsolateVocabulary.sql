CREATE TABLE ApiDB.IsolateVocabulary (
 isolate_vocabulary_id       NUMERIC(10),
...
SELECT nextval('core.tableinfo_sq'), 'IsolateVocabulary',
...
WHERE lower('IsolateVocabulary') NOT IN (SELECT lower(name) FROM core.TableInfo
