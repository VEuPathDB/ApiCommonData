...
apidb.SequenceAttributes@CRYPTO
UNION
SELECT SequenceAttributes.* FROM  
apidb.SequenceAttributes@PLASMO
UNION
SELECT SequenceAttributes.* FROM  
apidb.SequenceAttributes@TOXO
UNION
SELECT SequenceAttributes.* FROM  
apidb.SequenceAttributes@AMITO
UNION
SELECT 
...
prompt *****select count(*) from apidb.sequenceattributes@CRYPTO;
select count(*) from apidb.sequenceattributes@CRYPTO;
prompt *****select count(*) from apidb.sequenceattributes@PLASMO;
select count(*) from apidb.sequenceattributes@PLASMO;
prompt *****select count(*) from apidb.sequenceattributes@TOXO;
select count(*) from apidb.sequenceattributes@TOXO;
prompt *****select count(*) from apidb.sequenceattributes@AMITO;
select count(*) from apidb.sequenceattributes@AMITO;
