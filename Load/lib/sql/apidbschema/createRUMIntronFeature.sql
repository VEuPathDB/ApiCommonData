...
CREATE TABLE apidb.RUMIntronFeature (
 ...
 known_intron                    NUMBER(10) NOT NULL,
 standard_splice_signal                    NUMBER(10) NOT NULL,
 signal_not_canonical                    NUMBER(10) NOT NULL,
 ambiguous                    NUMBER(10) NOT NULL,
 long_overlap_unique_reads                    NUMBER(10) NOT NULL,
 short_overlap_unique_reads                    NUMBER(10) NOT NULL,
 long_overlap_nu_reads                    NUMBER(10) NOT NULL,
 short_overlap_nu_reads                    NUMBER(10) NOT NULL,
