CREATE TABLE apidb.SubjectResult (
 subject_result_id         NUMERIC(12) NOT NULL,
...
CREATE INDEX subjres_revix0 ON apidb.SubjectResult (subject, subject_result_id) TABLESPACE indx;
CREATE INDEX subjres_revix1 ON apidb.SubjectResult (protocol_app_node_id, subject_result_id) TABLESPACE indx;
...
SELECT NEXTVAL('core.tableinfo_sq'), 'SubjectResult',
