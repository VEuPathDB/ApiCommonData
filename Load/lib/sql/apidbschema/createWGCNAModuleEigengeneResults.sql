...
CREATE INDEX apidb.egenewgcnares_1 ON apidb.EigengeneWGCNAResults (na_feature_id) TABLESPACE indx;
CREATE INDEX apidb.egenewgcnares_2 ON apidb.EigengeneWGCNAResults (protocol_app_node_id) TABLESPACE indx;
