CREATE TABLE apidb.LopitResults (
 lopit_result_id              NUMERIC(12) NOT NULL,
 na_feature_id                NUMERIC(12) NOT NULL,
 probability_mean             FLOAT8  NOT NULL,
 sd                           FLOAT8,
 lower_CI                     FLOAT8,
 upper_CI                     FLOAT8,
...
CREATE INDEX lopitres_1 ON apidb.LopitResults (na_feature_id) TABLESPACE indx;
CREATE INDEX lopitres_2 ON apidb.LopitResults (protocol_app_node_id) TABLESPACE indx;
...
SELECT NEXTVAL('core.tableinfo_sq'), 'LopitResults',
