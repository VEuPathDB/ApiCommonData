...
begin
    ...
    if queryFailed then
         ...
         case lowerOrg
            ...
            when 'agaricomycetes' then project := 'FungiDB';
            when 'ajellomyces' then project := 'FungiDB';
            when 'ajellomycetaceae' then project := 'FungiDB';
            when 'allomyces' then project := 'FungiDB';
            when 'amoebozoa' then project := 'AmoebaDB';
            when 'anncaliia' then project := 'MicrosporidiaDB';
            when 'apicomplexa' then project := 'ToxoDB';
            when 'aspergillaceae' then project := 'FungiDB';
            when 'aspergillus' then project := 'FungiDB';
            when 'babesia' then project := 'PiroplasmaDB';
            when 'babesiidae' then project := 'PiroplasmaDB';
            when 'batrachochytrium' then project := 'FungiDB';
            when 'blastocladiaceae' then project := 'FungiDB';
            when 'botryotinia' then project := 'FungiDB';
            when 'candida' then project := 'FungiDB';
            when 'chytridiomycetes' then project := 'FungiDB';
            when 'coccidioides' then project := 'FungiDB';
            when 'coprinopsis' then project := 'FungiDB';
            when 'corticiaceae' then project := 'FungiDB';
            when 'crithidia' then project := 'TriTrypDB';
            when 'cryptococcus' then project := 'FungiDB';
            ...
            when 'emericella' then project := 'FungiDB';
            ...
            when 'eurotiomycetes' then project := 'FungiDB';
            when 'fusarium' then project := 'FungiDB';
            ...
            when 'hyaloperonospora' then project := 'FungiDB';
            when 'hypocreaceae' then project := 'FungiDB';
            when 'kinetoplastida' then project := 'TriTrypDB';
            when 'leishmania' then project := 'TriTrypDB';
            when 'leotiomycetes' then project := 'FungiDB';
            when 'magnaporthaceae' then project := 'FungiDB';
            when 'magnaporthe' then project := 'FungiDB';
            when 'malassezia' then project := 'FungiDB';
            when 'malasseziaceae' then project := 'FungiDB';
            when 'melampsora' then project := 'FungiDB';
            when 'melampsoraceae' then project := 'FungiDB';
            when 'microsporidia' then project := 'MicrosporidiaDB';
            when 'missing' then project := 'FungiDB';
            when 'mucor' then project := 'FungiDB';
            when 'mucoraceae' then project := 'FungiDB';
            when 'muridae' then project := 'HostDB';
            when 'mus' then project := 'HostDB';
            when 'naegleria' then project := 'AmoebaDB';
            when 'nectriaceae' then project := 'FungiDB';
            when 'nematocida' then project := 'MicrosporidiaDB';
            when 'neosartorya' then project := 'FungiDB';
            when 'neospora' then project := 'ToxoDB';
            when 'neurospora' then project := 'FungiDB';
            when 'nosema' then project := 'MicrosporidiaDB';
            when 'nosematidae' then project := 'MicrosporidiaDB';
            when 'onygenales' then project := 'FungiDB';
            when 'oomycetes' then project := 'FungiDB';
            when 'peronosporaceae' then project := 'FungiDB';
            when 'peronosporales' then project := 'FungiDB';
            when 'phanerochaete' then project := 'FungiDB';
            when 'phycomyces' then project := 'FungiDB';
            when 'phycomycetaceae' then project := 'FungiDB';
            when 'phytophthora' then project := 'FungiDB';
            when 'plasmodium' then project := 'PlasmoDB';
            when 'pleistophoridae' then project := 'MicrosporidiaDB';
            when 'pneumocystidaceae' then project := 'FungiDB';
            when 'pneumocystis' then project := 'FungiDB';
            when 'psathyrellaceae' then project := 'FungiDB';
            when 'puccinia' then project := 'FungiDB';
            when 'pucciniaceae' then project := 'FungiDB';
            when 'pucciniomycetes' then project := 'FungiDB';
            when 'pythiaceae' then project := 'FungiDB';
            when 'pythium' then project := 'FungiDB';
            when 'rhizophydiales' then project := 'FungiDB';
            when 'rhizopodaceae' then project := 'FungiDB';
            when 'rhizopus' then project := 'FungiDB';
            when 'saccharomyces' then project := 'FungiDB';
            when 'saccharomycetaceae' then project := 'FungiDB';
            when 'saccharomycetales' then project := 'FungiDB';
            when 'saccharomycetes' then project := 'FungiDB';
            when 'saprolegnia' then project := 'FungiDB';
            when 'saprolegniaceae' then project := 'FungiDB';
            when 'sarcocystidae' then project := 'ToxoDB';
            when 'sarcocystis' then project := 'ToxoDB';
            when 'schizosaccharomyces' then project := 'FungiDB';
            when 'schizosaccharomycetaceae' then project := 'FungiDB';
            when 'schizosaccharomycetes' then project := 'FungiDB';
            when 'sclerotinia' then project := 'FungiDB';
            when 'sclerotiniaceae' then project := 'FungiDB';
            ...
            when 'talaromyces' then project := 'FungiDB';
            when 'theileria' then project := 'PiroplasmaDB';
            when 'theileriidae' then project := 'PiroplasmaDB';
            when 'toxoplasma' then project := 'ToxoDB';
            when 'tremella' then project := 'FungiDB';
            when 'tremellaceae' then project := 'FungiDB';
            when 'tremellomycetes' then project := 'FungiDB';
            when 'trichocomaceae' then project := 'FungiDB';
            when 'trichoderma' then project := 'FungiDB';
            ...
            when 'ustilaginaceae' then project := 'FungiDB';
            when 'ustilaginomycetes' then project := 'FungiDB';
            when 'ustilago' then project := 'FungiDB';
