...
CREATE INDEX apidb.cp_extDbRlsIx ON apidb.CompoundPeaks(external_database_release_id, compound_peaks_id) TABLESPACE indx;
...
CREATE INDEX apidb.cpc_cmppIx ON apidb.CompoundPeaksChebi(compound_peaks_id, compound_peaks_chebi_id) TABLESPACE indx;
CREATE INDEX apidb.cpc_cmpIx ON apidb.CompoundPeaksChebi(compound_id, compound_peaks_chebi_id) TABLESPACE indx;
...
CREATE INDEX apidb.cmsr_panIx ON apidb.CompoundMassSpecResult(protocol_app_node_id, compound_mass_spec_result_id) TABLESPACE indx;
CREATE INDEX apidb.cmsr_cpiIx ON apidb.CompoundMassSpecResult(compound_peaks_id, compound_mass_spec_result_id) TABLESPACE indx;
