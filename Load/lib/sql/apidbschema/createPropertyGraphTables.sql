...
CREATE TABLE apidb.AttributeValue (
 ...
 vertex_attributes_id         NUMBER(12) NOT NULL,
 vertex_type_id               NUMBER(12) NOT NULL,
 incoming_edge_type_id        NUMBER(12),
 ...
 row_project_id               NUMBER(4) NOT NULL,
 row_alg_invocation_id        NUMBER(12) NOT NULL,
 FOREIGN KEY (vertex_attributes_id) REFERENCES apidb.VertexAttributes,
 FOREIGN KEY (vertex_type_id) REFERENCES apidb.VertexType,
 FOREIGN KEY (incoming_edge_type_id) REFERENCES apidb.EdgeType,
