...
create index ApidbTuning.IsolateSNPs_is_sid_idx on ApidbTuning.IsolateSNPs (is_source_id);
create index ApidbTuning.IsolateSNPs_snp_db_id_idx on ApidbTuning.IsolateSNPs (snp_db_name,snp_source_id,allele);
create index ApidbTuning.IsolateSNPs_snp_id_idx on ApidbTuning.IsolateSNPs (snp_source_id);
create index ApidbTuning.IsolateSNPs_snp_seq_start_idx on ApidbTuning.IsolateSNPs (snp_na_sequence_id,snp_start_min);
