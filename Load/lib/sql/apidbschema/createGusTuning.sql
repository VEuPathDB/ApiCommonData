...
create table Results.OtuAbundance
  (
    ...
    PROTOCOL_APP_NODE_ID  number(10) not null,
    reference_16s_id           number(12) not null,
    raw_count                  number(20),
    ...
    ROW_ALG_INVOCATION_ID number(12) not null,
    foreign key (PROTOCOL_APP_NODE_ID) references STUDY.PROTOCOLAPPNODE,
    foreign key (reference_16s_id) references APIDB.REFERENCE16S,
...
create unique index results.uqOtuAbundance
      on results.OtuAbundance (reference_16s_id, protocol_app_node_id);
