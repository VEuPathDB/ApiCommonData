...
sub munge {
	...
	# Assuming we want to look at the first strand, and only exclude pseudogenes. Previously
	# lin had investigated doing either first or second strand, and running either protein
	# coding genes only or only excluding pseudogenes. 
