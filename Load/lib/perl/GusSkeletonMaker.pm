...
sub makeGusGene {
  ...
  $plugin->error("Trying to make gus skeleton from a tree rooted with an unexpected type: '$type'") unless (grep {$type eq $_} ("coding_gene", "tRNA_gene", "rRNA_gene", "snRNA_gene"));
