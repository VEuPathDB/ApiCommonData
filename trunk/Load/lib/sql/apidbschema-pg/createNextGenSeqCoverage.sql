...
next_gen_seq_coverage_id NUMERIC(10),
...
CREATE INDEX nextgenseqcov_indx
...
SELECT nextval('core.tableinfo_sq'), 'NextGenSeqCoverage',
...
WHERE lower('NextGenSeqCoverage') NOT IN (SELECT lower(name) FROM core.TableInfo
